...
export default function Home() {
    ...
    return (
        <>
            ...
            <Typography sx={{ color: 'text.secondary', maxWidth: '76ch', fontSize: '1.5rem' }} paragraph>
            ...
            <Typography sx={{ color: 'text.secondary', maxWidth: '76ch', fontSize: '1.5rem' }}>Try <Link href='/api/v1/cafes'>/api/v1/cafes</Link></Typography>
        </>
    )
}
